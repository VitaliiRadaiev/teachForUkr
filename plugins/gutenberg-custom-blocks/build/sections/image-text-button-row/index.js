...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"t4u/image-text-button-row","version":"0.1.0","title":"Картинка + текст горизонтально","category":"image-text-button-row","icon":"layout","description":"","supports":{"html":false},"attributes":{"isHide":{"type":"boolean","default":false},"padding":{"type":"object","default":{"top":"lg","right":"","bottom":"lg","left":""}},"margin":{"type":"object","default":{"top":"","right":"","bottom":"","left":""}},"background":{"type":"string","enum":["bg-light-primary","bg-light-primary-80"],"default":"bg-light-primary-80"},"directions":{"type":"string","enum":["left","right"],"default":"left"},"decor":{"type":"number","default":1},"preview":{"type":"string"},"id":{"type":"string"}},"textdomain":"image-text-button-row","editorScript":"file:./index.js","editorStyle":"file:./index.css","render":"file:./render.php"}');
