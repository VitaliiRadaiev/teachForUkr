...
/***/ "./src/sections/reviews-slider/block.json":
/*!************************************************!*\
  !*** ./src/sections/reviews-slider/block.json ***!
  \************************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"t4u/reviews-slider","version":"0.1.0","title":"Відгуки слайдер","category":"news_stories_cases_other","icon":"layout","description":"","example":{},"supports":{"html":false},"attributes":{"isHide":{"type":"boolean","default":false},"padding":{"type":"object","default":{"top":"lg","right":"","bottom":"lg","left":""}},"margin":{"type":"object","default":{"top":"","right":"","bottom":"","left":""}},"background":{"type":"string","enum":["bg-light-primary","bg-light-primary-80"],"default":"bg-light-primary-80"},"decor":{"type":"number","default":0},"preview":{"type":"string"},"selectedCategories":{"type":"array","default":[]},"selectedPosts":{"type":"array","default":[]},"id":{"type":"string"}},"textdomain":"reviews-slider","editorScript":"file:./index.js","editorStyle":"file:./index.css","viewScript":"file:./script.js","render":"file:./render.php"}');

/***/ }),

/***/ "./src/sections/reviews-slider/edit.js":
/*!*********************************************!*\
  !*** ./src/sections/reviews-slider/edit.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/sections/reviews-slider/editor.scss");
...
/* harmony import */ var _hooks_hooks__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../hooks/hooks */ "./src/hooks/hooks.js");
...
/* harmony import */ var _ui_slider_nav_SliderNav__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../ui/slider-nav/SliderNav */ "./src/ui/slider-nav/SliderNav.js");
...
function Edit({
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.useBlockProps)({
    className: (0,clsx__WEBPACK_IMPORTED_MODULE_5__["default"])('reviews-slider-section rounded-[20px] md:rounded-[30px] overflow-hidden relative', className, background, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_6__.getSectionsMarginClasses)(margin), (0,_utils_utils__WEBPACK_IMPORTED_MODULE_6__.getSectionsPaddingClasses)(padding), {
      ['hide-block']: isHide
    })
  });
  const {
  ...
  const fetchPosts = () => _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_11___default()({
    path: `site-core/v1/review${selectedCategories.length ? `?category=${selectedCategories.join(',')}` : ''}`
  });
  const {
    ref,
    data,
    isLoading,
    refetch
  } = (0,_hooks_hooks__WEBPACK_IMPORTED_MODULE_10__["default"])(fetchPosts);
  const fetchPostsByIds = () => _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_11___default()({
    path: `site-core/v1/review-by-ids?ids=${selectedPosts.join(',')}`
  });
  const {
    ref: postsByIdsRef,
    data: postsByIdsData,
  ...
  } = (0,_hooks_hooks__WEBPACK_IMPORTED_MODULE_10__["default"])(fetchPostsByIds);
  const fetchCategoriesData = () => _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_11___default()({
    path: 'site-core/v1/review-categories'
  });
  const {
    ref: refCategories,
    data: dataCategories,
    isLoading: isLoadingCategories
  } = (0,_hooks_hooks__WEBPACK_IMPORTED_MODULE_10__["default"])(fetchCategoriesData);
  const fetchPostsForFilter = () => {
    const path = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_6__.buildApiPath)('site-core/v1/review', {
  ...
  } = (0,_hooks_hooks__WEBPACK_IMPORTED_MODULE_10__["default"])(fetchPostsForFilter);
  ...
  const handleCategoryChange = (checkedCategory, selectedCategories, isChecked) => {
    ...
    refetch(() => _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_11___default()({
      path: `site-core/v1/review${ids.length ? `?category=${ids.join(',')}` : ''}`
    }));
    loadPostsForFilter({
      selectedCategories: ids,
      page: 1,
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    refetchPostsByIds(() => _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_11___default()({
      path: `site-core/v1/review-by-ids?ids=${selectedPosts.join(',')}`
    }));
  }, [selectedPosts]);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_components_default_sections_controls_DefaultSectionsControls__WEBPACK_IMPORTED_MODULE_7__.DefaultSectionsControls, {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
          ...
          children: [isLoadingCategories && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
            ...
            children: dataCategories.map(category => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.Fragment, {
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.CheckboxControl, {
                label: category.name,
            ...
            children: "\u0412\u0456\u0434\u043E\u0431\u0440\u0430\u0437\u0438\u0442\u0438 \u0442\u0456\u043B\u044C\u043A\u0438 \u043E\u0431\u0440\u0430\u043D\u0456 \u0432\u0456\u0434\u0433\u0443\u043A\u0438"
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_components_section_decor_picker_SectionsDecorPicker__WEBPACK_IMPORTED_MODULE_8__.SectionsDecorPicker, {
        decor: decor,
      ...
      ...blockProps,
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_ui_section_decor_SectionDecor__WEBPACK_IMPORTED_MODULE_9__.SectionDecor, {
        decor: decor
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
        ref: (0,_utils_utils__WEBPACK_IMPORTED_MODULE_6__.mergeRefs)(ref, refCategories, postsByIdsRef, postsForFilterRef),
        className: (0,clsx__WEBPACK_IMPORTED_MODULE_5__["default"])("container relative z-2 flex flex-col", {
        ...
        children: [children, /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
          ...
          children: [isLoading && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
            ...
            className: "swiper [&.swiper]:overflow-visible [&:not(.swiper-initialized)_.swiper-wrapper]:gap-[10px] md:[&:not(.swiper-initialized)_.swiper-wrapper]:gap-[20px] lg:[&:not(.swiper-initialized)_.swiper-wrapper]:gap-[24px] 4xl:[&:not(.swiper-initialized)_.swiper-wrapper]:gap-[30px] [&_.swiper-slide]:w-[323px] md:[&_.swiper-slide]:w-[537px]",
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
              ...
              children: renderPosts.map(post => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
                ...
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
                  className: "flex flex-col h-full nested-bg-item rounded-[12px] p-[16px] md:p-[30px]",
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
                    className: "h-[16px] md:h-[20px] accent-second-filter",
                    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("img", {
                      class: "h-full w-auto",
                      src: (0,_utils_utils__WEBPACK_IMPORTED_MODULE_6__.getUrlToStaticImages)('icons/semi-circle-right-double.svg'),
                      alt: "decor"
                    })
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
                    className: "mt-[20px] md:mt-[30px] shrink grow text-md",
                    children: post.excerpt
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
                    className: "mt-[20px] md:mt-[30px] flex gap-[16px]",
                    children: [post.image ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
                      className: "grow-0 shrink-0 h-[56px] w-[56px] rounded-full overflow-hidden relative",
                      dangerouslySetInnerHTML: {
                        __html: post.image
                      }
                    }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
                      className: "grow-0 shrink-0 h-[56px] w-[56px] rounded-full overflow-hidden relative bg-[--bg] flex items-center justify-center",
                      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("img", {
                        className: "color-light-primary-60-filter h-[26px] w-auto",
                        src: (0,_utils_utils__WEBPACK_IMPORTED_MODULE_6__.getUrlToStaticImages)('icons/user.svg'),
                        alt: "placeholder"
                      })
                    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
                      className: "self-center",
                      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
                        className: "h4 text-dark-primary",
                        children: post.title
                      }), !!post.position && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
                        className: "mt-[2px] text-sm",
                        children: post.position
                      })]
                    })]
                  })]
                })
            ...
            className: "text-center text-lg",
            children: "\u041D\u0435 \u0437\u043D\u0430\u0439\u0434\u0435\u043D\u043E"
          }), renderPosts.length > 2 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_ui_slider_nav_SliderNav__WEBPACK_IMPORTED_MODULE_12__.SliderNav, {})]
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
            className: "text-lg",
            children: ["\u041E\u0431\u0440\u0430\u043D\u0456 \u0432\u0456\u0434\u0433\u0443\u043A\u0438, ", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("strong", {
              className: "text-sm",
              children: "\u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0438 \u043D\u0438\u0436\u0447\u0435 \u0432\u0456\u0434\u043E\u0431\u0440\u0430\u0436\u0430\u044E\u0442\u044C\u0441\u044F \u0442\u0456\u043B\u044C\u043A\u0438 \u0442\u0443\u0442, \u0432 \u0440\u0435\u0436\u0438\u043C\u0456 \u043D\u0430\u043F\u043E\u0432\u0435\u043D\u043D\u044F \u0441\u0430\u0439\u0442\u0443"
            })]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
            className: "mt-[20px] selectedNews grid lg:grid-cols-3 gap-[10px] lg:gap-[24px]",
            children: renderPosts.map(post => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
              className: "swiper-slide !h-auto relative",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("button", {
                ...
                className: "relative z-1flex flex-col h-full nested-bg-item rounded-[12px] p-[16px] md:p-[30px] pointer-events-none",
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
...
/***/ "./src/sections/reviews-slider/editor.scss":
/*!*************************************************!*\
  !*** ./src/sections/reviews-slider/editor.scss ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/sections/reviews-slider/save.js":
/*!*********************************************!*\
  !*** ./src/sections/reviews-slider/save.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!**********************************************!*\
  !*** ./src/sections/reviews-slider/index.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./src/sections/reviews-slider/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./save */ "./src/sections/reviews-slider/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/sections/reviews-slider/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_3__.name, {
  ...
  example: {
    attributes: {
      preview: 'general/preview-section-reviews-slider.jpg'
    }
  }
});
})();
