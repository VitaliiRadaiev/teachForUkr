export const SliderNav = () => {
    return (
        <>
            <div className="mt-[20px] md:mt-[30px] flex justify-center [&:has(.swiper-pagination-lock)]:hidden">
            ...
            <div className="hidden lg:block absolute right-0 bottom-[calc(100%+50px)]">
