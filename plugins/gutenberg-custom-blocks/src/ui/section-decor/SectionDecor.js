            ...
            <div className="container h-full relative">
                {decor === 1 &&
                    <div className="absolute right-0 bottom-[70px] md:bottom-[80px] lg:bottom-[100px] h-[212px] md:h-[406px] w-auto z-1 pointer-events-none flex">
                        <img className="accent-second-50-filter h-1/2 w-auto mt-auto aos-rotate-right" src={getUrlToStaticImages('icons/semicircle-bottom.svg')} alt="" />
                        <img className="accent-second-50-filter h-full w-auto aos-rotate-left" src={getUrlToStaticImages('icons/semi-tours-left.svg')} alt="" />
                    </div>
                }
                {decor === 2 &&
                ...
                {decor === 3 &&
                    <div className="absolute left-0 bottom-0 h-[212px] md:h-[406px] w-auto z-1 pointer-events-none flex -translate-x-1/2">
                        <img className="accent-second-50-filter h-1/2 w-auto mt-auto aos-rotate-right" src={getUrlToStaticImages('icons/semi-torus-top.svg')} alt="" />
                    </div>
                }
                {decor === 4 &&
