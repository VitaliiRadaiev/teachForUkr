...
export default function Edit({ attributes, setAttributes, clientId }) {
	...
	const { updateBlockAttributes, insertBlock, removeBlock, updateBlock, ...rest } = useDispatch('core/block-editor');

	const { innerBlocks, getBlocks} = useSelect((select) => {
		return {
	...
	return (
		<>
			<InspectorControls>
				...
				/>
				<PanelBody title="Варіанти масок" initialOpen={true}>
					<RadioControl
						selected={mask}
						options={[
							{
